...
pub const EXPONENT_CLMM_ID_MAINNET: Pubkey =
    pubkey!("XPC1MM4dYACDfykNuXYZ5una2DsMDWL24CrYubCvarC");
...
pub const CPI_WHITELISTED_ACCOUNTS: [CpiWhitelistedAccount; 18] = [
    ...
    CpiWhitelistedAccount::new(EXPONENT_CLMM_ID_MAINNET, 2),
    CpiWhitelistedAccount::new(EXPONENT_ORDERBOOK_ID_MAINNET, 2),
